...
gall.insertAdjacentHTML("beforeend", createGall(images));

gall.style.gap = "24px";
gall.style.display = "flex";
gall.style.flexWrap = "wrap";
gall.style.justifyContent = "center";
gall.style.alignItems = "center";
gall.style.listStyle = "none";
